package org.semantikos.bnc.objects

import org.semantikos.common.IgnoreException
...
class BncExtendedRecord(
    ...
    override fun dataRow(): String {
        return "'${Utils.escape(word)}','$pos',$freq,$range,$dispersion,$freq2,$range2,$dispersion2,$lL"
    }
