...
sqlite3 "${db}" "DELETE FROM sources WHERE name <> 'WordNet' AND name <> 'Open English Wordnet' AND name <> 'Open English Namenet' AND name <> 'VerbNet' AND name <> 'PropBank' AND name <> 'SyntagNet'"
