...
The Necessity of Parsing for Predicate Argument Recognition. Daniel Gildea and Martha Palmer. 2002. In Proceedings of ACL 2002, Philadelphia, PA.'),
 ...
 (6,'PredicateMatrix','1.3',NULL,'http://adimen.si.ehu.es/web/PredicateMatrix/','University of the Basque Country','López de Lacalle M., Laparra E. and Rigau G. First steps towards a Predicate Matrix. Proceedings of the 7th Global WordNet Conference (GWC 2014). Tartu, Estonia. 2014.
...
López de Lacalle M., Laparra E., Aldabe I. and Rigau G. A Multilingual Predicate Matrix. Proceedings of the 10th international conference on Language Resources and Evaluation (LREC 2016). Portoroẑ, Slovenia. 2016.'),
 ...
 (12,'ILFWn','0.2','3.0','http://nlp.uned.es/semantics/ilf/ilf.html','Universidad Politécnica de Madrid',NULL),
