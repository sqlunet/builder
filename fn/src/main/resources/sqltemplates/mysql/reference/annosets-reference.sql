ALTER TABLE ${annosets.table} ADD CONSTRAINT fk_${annosets.table}_${annosets.sentenceid} FOREIGN KEY (${annosets.sentenceid}) REFERENCES ${sentences.table} (${sentences.sentenceid});
