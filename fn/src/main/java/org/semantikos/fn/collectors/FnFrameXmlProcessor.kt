...
import org.semantikos.common.XmlChecker.checkAttributeName
import org.semantikos.common.XmlChecker.checkElementName
import org.semantikos.common.XmlChecker.checkSubElements
...
class FnFrameXmlProcessor : XmlProcessor() {
                    ...
                    r.childNodes
                        ...
                        .forEach {
                            if (it !is Element) {
                                ...
                                // transform
                                checkElementName(name2, "(fen|t|ex|ment|em)", "top")
                                when (name2) {
                                    "ex"   -> {
                                        checkAttributeName(e2, null, name2, LOG_ONLY)
                                    ...
                                    "fen"  -> {
                                        checkSubElements(e2, null, name2, LOG_ONLY)
                                        checkAttributeName(e2, null, name2, LOG_ONLY)
                                    ...
                                    "ment" -> {
                                        ...
                                        checkSubElements(e2, "(fen)", name2, LOG_ONLY)
                                        checkAttributeName(e2, null, name2, LOG_ONLY)
                ...
                .forEach {
                    if (it !is Element) {
                        ...
                        when (name2) {
                            ...
                            "x"   -> {
                                checkSubElements(e2, "(fex|t)", "x", LOG_ONLY)
                                checkAttributeName(e2, null, name2, LOG_ONLY)
