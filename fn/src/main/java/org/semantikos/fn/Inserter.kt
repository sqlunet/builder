...
import org.semantikos.common.Insert.insertAndIncrement
import org.semantikos.common.Insert.insertFragmented
import org.semantikos.common.Insert.insertStrings
...
import org.semantikos.fn.joins.*
import org.semantikos.fn.objects.*
import org.semantikos.fn.objects.Values.LabelIType
import org.semantikos.fn.types.*
...
open class Inserter(
    ...
    fun insertFrames() {
        traceSaving("frames")
        insert(Frame.SET, compareBy(Frame::iD), File(outDir, names.file("frames")), names.table("frames"), names.columns("frames"), header)
        Frame.SET.clear()
        traceDone()
