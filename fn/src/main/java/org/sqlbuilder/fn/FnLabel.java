...
public class FnLabel implements Insertable<FnLabel>
{
	public static final Set<FnLabel> SET = new HashSet<>();

	public final LabelType label;

	public final FnLayer layer;

	public FnLabel(final FnLayer layerid, final LabelType label)
	{
		this.layer = layerid;
		this.label = label;
	}
