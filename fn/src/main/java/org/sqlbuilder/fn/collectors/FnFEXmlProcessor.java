		...
		for (int i = 0; i < roots.getLength(); i++)
		{
			...
			for (int j = 0; j < nodes.getLength(); j++)
			{
				...
				else
				{
					...
					{
						case "ex":
							Checker.checkAttributeName(e2, null, "ex");
						...
						case "fen":
						{
							Checker.checkSubElements(e2, null, null);
							Checker.checkAttributeName(e2, null, null);
			...
			else
			{
				...
				switch (name2)
				{
					case "fex":
					{
						...
						Checker.checkSubElements(e2, "(t)", null);
						Checker.checkAttributeName(e2, "(name)", null);
					...
					case "t":
					{
						// TODO 59 errors
						// Checker.check_SubElements(e2, null, null);
						Checker.checkSubElements(e2, "(fex)", null);
						Checker.checkAttributeName(e2, null, null);
