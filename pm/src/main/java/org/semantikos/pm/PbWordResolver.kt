...
class PbWordResolver(ser: String) :
    Resolver<PmPbWordResolvable, PmPbWordResolved>(if (ser.endsWith(".json")) deserializeJson<PmPbWordResolved>(File(ser)) else deserialize(File(ser)))
