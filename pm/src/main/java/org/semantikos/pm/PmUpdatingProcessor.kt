    ...
    private fun makeXnConsumer(ps: PrintStream): (PmEntry, Int) -> Unit {
        return { entry, i ->
            updateVnPbFnRow(
                ps,
                names.table("pms"), i, entry,
                names.column("pms.vn_wordid"),
                names.column("pms.pb_wordid"),
                names.column("pms.fn_wordid"),
                names.column("pms.vn_classid"),
                names.column("pms.vn_roleid"),
                names.column("pms.pb_rolesetid"),
                names.column("pms.pb_roleid"),
                names.column("pms.fn_frameid"),
                names.column("pms.fn_feid"),
                names.column("pms.fn_luid"),
                names.column("pms.word"),
                names.column("pms.vn_class"),
                names.column("pms.vn_role"),
                names.column("pms.pb_roleset"),
                names.column("pms.pb_role"),
                names.column("pms.fn_frame"),
                names.column("pms.fn_fe")
            )
        }
    }
