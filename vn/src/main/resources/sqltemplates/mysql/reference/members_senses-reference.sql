...
ALTER TABLE ${members_senses.table} ADD CONSTRAINT fk_${members_senses.table}_${members_senses.vnwordid} FOREIGN KEY (${members_senses.vnwordid}) REFERENCES ${words.table} (${words.wordid});
