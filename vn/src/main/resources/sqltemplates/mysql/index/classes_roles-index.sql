CREATE UNIQUE INDEX unq_${classes_roles.table}_${classes_roles.roleid}_${classes_roles.classid} ON ${classes_roles.table} (${classes_roles.roleid},${classes_roles.classid});
