 ...
 */
package org.semantikos

import org.semantikos.bnc.BncModule
...
import org.semantikos.pm.PmModule
import org.semantikos.sl.SlModule
import org.semantikos.sn.SnModule
            ...
            runModules.forEach { m ->
                ops.forEach { o ->
                    ...
                    args.forEach {
                        ...
                        println(magenta("MODULE:$m OP:$it DATA:$data->${data.absolutePath} ARGS:${args.joinToString(separator = " ")}"))
                        run(m, args)
                    }
                }
            }
