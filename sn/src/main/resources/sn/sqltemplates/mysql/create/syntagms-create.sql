CREATE TABLE ${syntagms.table} (
    ...
    ${syntagms.sensekey1} VARCHAR (100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_cs NOT NULL,
    ${syntagms.sensekey2} VARCHAR (100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_cs NOT NULL
);
