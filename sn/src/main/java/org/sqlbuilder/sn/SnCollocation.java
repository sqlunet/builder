...
public class SnCollocation implements Insertable
{
	...
	public SnCollocation(long offset1, char pos1, String lemma1, long offset2, char pos2, String lemma2)
	{
	...
	public static SnCollocation parse(String line) throws ParseException
	{
		try
		{
			...
			return new SnCollocation(synset1Id, pos1, lemma1, synset2Id, pos2, lemma2);
		}
		catch (Exception e)
		{
