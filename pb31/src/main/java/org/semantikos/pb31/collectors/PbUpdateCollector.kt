...
import org.semantikos.pb31.collectors.PbDocument.Companion.getAliasPredicates
import org.semantikos.pb31.collectors.PbDocument.Companion.getPredicates
import org.semantikos.pb31.collectors.PbDocument.Companion.makeExampleArgs
import org.semantikos.pb31.collectors.PbDocument.Companion.makeExamples
...
class PbUpdateCollector(conf: Properties) : PbCollector(conf) {
    ...
    override fun run() {
        ...
        val fileArray = folder.listFiles(filter) ?: throw RuntimeException("Dir:$propBankHome is empty")
