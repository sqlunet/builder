...
public class C
{
	...
	static public final class AnyRelations
	{
	...
	static public final class AnyRelations_Senses_Words_X
	{
		static public final String TABLE_BY_SYNSET = "anyrelations_senses_relations_senses_words_by_synset";
		static public final String CONTENT_URI_TABLE = AnyRelations_Senses_Words_X.TABLE_BY_SYNSET;
		static public final String SYNSET1ID = "synset1id";
		static public final String SYNSET2ID = "synset2id";
